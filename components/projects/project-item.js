...
export default function ProjectItem({data}){
    ...
    return ( 
            <Card className={styles.project_item} sx={{width : 345, display: 'flex', flexDirection:'column',justifyContent:'space-between'}}>
                <CardMedia sx={{height : 180}} image={imgUrl} title={title}/>
